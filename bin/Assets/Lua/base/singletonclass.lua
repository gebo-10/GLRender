...
function SingletonClass:GetInstance()
    error("should implement GetInstance method")
end
...
function SingletonClass:Destroy()
    error("should implement Destroy method")
end

function SingletonClass:HasCreate()
    error("SingletonClass could not be implemented!")
end
